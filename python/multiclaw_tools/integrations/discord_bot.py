"""
Discord bot integration for MultiClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by MultiClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install multiclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"MultiClaw Discord Bot ready: {self.client.user}")
