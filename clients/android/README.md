# MultiClaw Android Client 🦀📱

Native Android client for MultiClaw - run your autonomous AI assistant on Android.
...
- 🦀 **MultiClaw Core** - Full Rust binary via UniFFI/JNI
...
Same as MultiClaw (MIT/Apache-2.0)
