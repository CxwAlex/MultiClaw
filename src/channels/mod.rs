    ...
    match channel_name {
        ...
        "whatsapp" => Some(
            "When responding on WhatsApp:\n\
             ...
             - The path MUST be an absolute filesystem path to a local file (e.g. [IMAGE:/home/nicolas/.multiclaw/workspace/images/chart.png]).\n\
             - Keep normal text outside markers and never wrap markers in code fences.\n\
...
fn collect_configured_channels(
    ...
    if let Some(ref mx) = config.channels_config.matrix {
        channels.push(ConfiguredChannel {
            display_name: "Matrix",
            channel: Arc::new(
                MatrixChannel::new_with_session_hint_and_multiclaw_dir(
                    mx.homeserver.clone(),
