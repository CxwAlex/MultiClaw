...
mod tests {
    ...
    fn gateway_cli_accepts_new_pairing_flag() {
        let cli = Cli::try_parse_from(["multiclaw", "gateway", "--new-pairing"])
    ...
    fn gateway_cli_defaults_new_pairing_to_false() {
        let cli = Cli::try_parse_from(["multiclaw", "gateway"]).expect("gateway should parse");
    ...
    fn onboard_cli_accepts_no_totp_flag() {
        let cli = Cli::try_parse_from(["multiclaw", "onboard", "--no-totp"])
