//! Plugin system for MultiClaw.
//!
//! Modeled after OpenClaw's plugin architecture, adapted for Rust:
//!
//! - **Manifest**: each plugin has a `multiclaw.plugin.toml` descriptor
//! - **Discovery**: scans bundled, global (`~/.multiclaw/extensions/`), and
//!   workspace (`.multiclaw/extensions/`) directories
...
mod tests {
    ...
    fn module_reexports_are_accessible() {
        ...
        assert_eq!(PLUGIN_MANIFEST_FILENAME, "multiclaw.plugin.toml");
    }
}
