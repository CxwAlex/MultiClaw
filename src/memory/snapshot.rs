...
const SNAPSHOT_HEADER: &str = "# 🧠 MultiClaw Memory Snapshot\n\n\
    > Auto-generated by MultiClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 MultiClaw Memory Snapshot

> Auto-generated by MultiClaw.
...
I am MultiClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 MultiClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
