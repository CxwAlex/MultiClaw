...
pub async fn run_wizard(force: bool) -> Result<Config> {
    ...
    print_step(3, 11, "Channels (How You Talk to MultiClaw)");
...
fn setup_identity_backend() -> Result<IdentityConfig> {
    print_bullet("Choose the identity format MultiClaw should scaffold for this workspace.");
        ...
        match choice {
            ...
            ChannelMenuChoice::LarkFeishu => {
                ...
                println!(
                    ...
                    style("— talk to MultiClaw from Lark or Feishu").dim()
                );
                print_bullet(
