...
//!
//! Provides two endpoints for callers migrating from OpenClaw to MultiClaw:
//!
//! 1. **`POST /api/chat`** (recommended) — MultiClaw-native endpoint that invokes the
...
//! MultiClaw's existing `/v1/chat/completions` (in `openai_compat.rs`) uses the
...
// ══════════════════════════════════════════════════════════════════════════════
// /api/chat — MultiClaw-native endpoint
// ══════════════════════════════════════════════════════════════════════════════
...
pub struct ApiChatBody {
    ...
    /// Use this to inject recent conversation history that MultiClaw's
...
/// `POST /v1/chat/completions` — OpenAI-compatible shim over MultiClaw's agent loop.
///
...
/// the same tools + memory experience as native MultiClaw channels.
