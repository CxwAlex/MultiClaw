...
mod tests {
    ...
    fn extract_ws_bearer_token_prefers_authorization_header() {
        ...
        headers.insert(
            ...
            HeaderValue::from_static("multiclaw.v1, bearer.from-protocol"),
        );
    ...
    fn extract_ws_bearer_token_reads_websocket_protocol_token() {
        ...
        headers.insert(
            header::SEC_WEBSOCKET_PROTOCOL,
            HeaderValue::from_static("multiclaw.v1, bearer.protocol-token"),
        );
    ...
    fn extract_ws_bearer_token_rejects_empty_tokens() {
        ...
        headers.insert(
            header::SEC_WEBSOCKET_PROTOCOL,
            HeaderValue::from_static("multiclaw.v1, bearer."),
        );
