# MultiClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for MultiClaw edge scenarios on ESP32.
...
```bash
cd firmware/multiclaw-esp32-ui
cargo build --release
...
3. Connect UI state with MultiClaw edge/runtime messaging
...
- [MultiClaw Hardware Design](../../docs/hardware-peripherals-design.md)
