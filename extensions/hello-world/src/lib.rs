//! Hello World — example MultiClaw plugin.
//!
...
//!
//! To enable this plugin, add to `~/.multiclaw/config.toml`:
//!
//! ```toml
//! [plugins]
//! enabled = true
...
use multiclaw::hooks::{HookHandler, HookResult};
use multiclaw::plugins::{Plugin, PluginApi, PluginManifest};
use multiclaw::tools::traits::{Tool, ToolResult, ToolSpec};
...
fn manifest() -> PluginManifest {
    PluginManifest {
        ...
        description: Some("Example plugin demonstrating the MultiClaw plugin API.".into()),
