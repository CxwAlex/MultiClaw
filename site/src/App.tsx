...
const repoBase = "https://github.com/multiclaw-labs/multiclaw/blob/main";
const rawBase = "https://raw.githubusercontent.com/multiclaw-labs/multiclaw/main";
...
const readingPaths: Array<{
  ...
  {
    id: "newcomer",
    label: { en: "New to MultiClaw", zh: "初次了解 MultiClaw" },
    detail: {
  ...
  },
  {
    ...
    detail: {
      en: "Connect MultiClaw with chat platforms and external providers.",
      zh: "将 MultiClaw 接入聊天平台与外部模型能力。",
    },
...
const copy = {
  en: {
    ...
    notice:
      "Official source channels: use this repository as the source of truth and multiclawlabs.ai as the official website.",
  ...
  zh: {
    ...
    summary2: "Deploy anywhere. Swap anything.",
    notice:
      "官方信息渠道：请以本仓库为事实来源，以 multiclawlabs.ai 为官方网站。",
    ctaDocs: "立即阅读文档",
    ctaBootstrap: "一键安装",
    ...
    startHereTitle: "新手起步",
    startHereLead: "面向首次接触 MultiClaw 的核心文档，快速完成有效上手。",
  ...
  return (
    <div className="zc-app">
      <header className="topbar">
        <div className="topbar-inner">
          ...
          <nav className="top-nav" aria-label="Primary">
            ...
            <a href="https://github.com/multiclaw-labs/multiclaw" target="_blank" rel="noreferrer">
              {text.navGitHub}
            </a>
            <a href="https://multiclawlabs.ai" target="_blank" rel="noreferrer">
              {text.navWebsite}
            </a>
          </nav>
      ...
      <footer className="footer">
        <p>
          MultiClaw · Trait-driven architecture · secure-by-default runtime ·
