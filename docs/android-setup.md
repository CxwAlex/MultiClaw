...
# For 64-bit (aarch64):
curl -LO https://github.com/multiclaw-labs/multiclaw/releases/latest/download/multiclaw-aarch64-linux-android.tar.gz
tar xzf multiclaw-aarch64-linux-android.tar.gz

# For 32-bit (armv7):
curl -LO https://github.com/multiclaw-labs/multiclaw/releases/latest/download/multiclaw-armv7-linux-androideabi.tar.gz
