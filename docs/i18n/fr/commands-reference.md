...
Cette page est une localisation initiale Wave 1 pour retrouver rapidement les commandes CLI MultiClaw.
...
- `multiclaw gateway` prend en charge `--new-pairing` pour effacer les tokens appairés et générer un nouveau code d'appairage.
