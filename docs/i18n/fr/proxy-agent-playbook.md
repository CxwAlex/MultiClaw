...
- [H3 · 1.1 Proxy only MultiClaw internal traffic](../../proxy-agent-playbook.md#1-1-proxy-only-multiclaw-internal-traffic)
...
- [H2 · 4. Mode A — Proxy Only for MultiClaw Internals](../../proxy-agent-playbook.md#4-mode-a-proxy-only-for-multiclaw-internals)
