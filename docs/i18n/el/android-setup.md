...
Το MultiClaw παρέχει προκατασκευασμένα εκτελέσιμα αρχεία (binaries) για συσκευές Android.
...
Ο ευκολότερος τρόπος εκτέλεσης του MultiClaw σε Android είναι μέσω [Termux](https://termux.dev/).
...
# Για 64-bit (aarch64):
curl -LO https://github.com/CxwAlex/multiclaw/releases/latest/download/multiclaw-aarch64-linux-android.tar.gz
tar xzf multiclaw-aarch64-linux-android.tar.gz

# Για 32-bit (armv7):
curl -LO https://github.com/CxwAlex/multiclaw/releases/latest/download/multiclaw-armv7-linux-androideabi.tar.gz
...
Για προχωρημένους χρήστες που θέλουν να εκτελέσουν το MultiClaw εκτός Termux:
