...
Οδηγίες για την αρχική εγκατάσταση και την εξοικείωση με το οικοσύστημα του MultiClaw.
...
|:---|:---|
| Διαθέτω API Key και επιθυμώ άμεση ρύθμιση | `multiclaw onboard --api-key sk-... --provider openrouter` |
| Επιθυμώ διαδραστική καθοδήγηση (Step-by-step) | `multiclaw onboard --interactive` |
| Επιθυμώ μόνο τη ρύθμιση καναλιών επικοινωνίας | `multiclaw onboard --channels-only` |
| Επιθυμώ πλήρη αντικατάσταση υπαρχουσών ρυθμίσεων | `multiclaw onboard --force` |
...
- **Έλεγχος Υγείας**: Μετά την εγκατάσταση, εκτελέστε τις εντολές `multiclaw status` και `multiclaw doctor` για την επαλήθευση της σωστής λειτουργίας.
