...
Αυτός ο οδηγός σας βοηθάει να συνδέσετε το MultiClaw με το Matrix και να λύσετε προβλήματα, ειδικά σε δωμάτια με κρυπτογράφηση (E2EE).
...
5. **Επανεκκίνηση**: Κάνατε επανεκκίνηση το MultiClaw μετά τις αλλαγές;
