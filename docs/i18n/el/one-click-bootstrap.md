...
Αυτός ο οδηγός περιγράφει την ταχύτερη μέθοδο για την εγκατάσταση και την αρχικοποίηση του MultiClaw.
...
```bash
curl -fsSL https://raw.githubusercontent.com/CxwAlex/multiclaw/main/scripts/bootstrap.sh | bash
```
> [!IMPORTANT]
...
./bootstrap.sh --docker
```
Το σενάριο θα δημιουργήσει μια τοπική εικόνα Docker και θα ξεκινήσει τη διαδικασία onboarding. Οι ρυθμίσεις αποθηκεύονται στον κατάλογο `./.multiclaw-docker`.
