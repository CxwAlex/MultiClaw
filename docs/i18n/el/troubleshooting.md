...
Αυτός ο οδηγός περιγράφει λύσεις για κοινά ζητήματα εγκατάστασης και εκτέλεσης του MultiClaw.
...
multiclaw doctor
```
Ελέγξτε τις ρυθμίσεις στο `~/.multiclaw/config.toml`:
...
Ελέγξτε την κατάσταση μέσω του MultiClaw CLI:
```bash
