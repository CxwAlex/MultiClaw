...
- `python3 scripts/ci/provider_connectivity_matrix.py --binary target/release-fast/multiclaw --contract .github/connectivity/probe-contract.json`
...
- `multiclaw channel start` starts all configured channels in one process.
...
Registry packages are installed to `~/.multiclaw/workspace/skills/<name>/`.
