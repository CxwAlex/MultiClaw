...
Scammers may impersonate MultiClaw maintainers, contributors, or community members.

Assume fraud if someone claiming to represent MultiClaw asks for:
...
MultiClaw maintainers do not request money or private wallet/financial credentials via direct messages.

## Official Sources Of Truth

Use these sources to verify announcements:

- GitHub repository: `CxwAlex/multiclaw`
...
3. Open a GitHub issue in `CxwAlex/multiclaw` with sanitized details.
