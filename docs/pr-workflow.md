# MultiClaw PR Workflow (High-Volume Collaboration)

This document defines how MultiClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to MultiClaw/project-native labels.
...
- Confirm any required identity-like wording uses MultiClaw/project-native terminology.
