...
5. In publish mode, workflow generates SBOM (`CycloneDX` + `SPDX`), `SHA256SUMS`, and a checksum provenance statement (`multiclaw.sha256sums.intoto.json`) plus audit-event envelope.
