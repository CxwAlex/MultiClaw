//! Example: Implementing a custom Memory backend for MultiClaw
//!
...
// ── Re-define the trait types (in your app, import from multiclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 MultiClaw Memory Demo — InMemoryBackend\n");
