...
Options:
    ...
    --repo OWNER/NAME   Repository (default: multiclaw-labs/multiclaw)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="multiclaw-labs/multiclaw",
        help="Repository in OWNER/NAME format (default: multiclaw-labs/multiclaw)",
    )
