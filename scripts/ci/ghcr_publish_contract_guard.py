...
POLICY_SCHEMA = "multiclaw.ghcr-tag-policy.v1"
...
def fetch_manifest(repository: str, tag: str, token: str) -> dict[str, object]:
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "multiclaw-ghcr-publish-contract-guard/1",
        },
        method="GET",
    )
...
def main() -> int:
    ...
    parser.add_argument("--repository", required=True, help="Repository path for GHCR API, e.g. multiclaw-labs/multiclaw")
    ...
    report = {
        "schema_version": "multiclaw.ghcr-publish-contract.v1",
