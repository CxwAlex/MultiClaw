...
REQUIRED_REFERENCES = {
    ...
    "sbom_cyclonedx": "multiclaw.cdx.json",
    "sbom_spdx": "multiclaw.spdx.json",
    "checksums_provenance": "multiclaw.sha256sums.intoto.json",
...
def main() -> int:
    ...
    report: dict[str, object] = {
        "schema_version": "multiclaw.release-notes-supply-chain.v1",
